  ...
  <section class="border border-gray-200 rounded-lg p-4">
    ...
    <div v-if="gatewayStore.session" class="mt-3 rounded-md bg-gray-50 border border-gray-200 p-3">
      ...
      <div v-if="gatewayStore.session.qr" class="mt-2">
        <ScannableQrCodePanel :qr-code="gatewayStore.session.qr.code" />
      </div>
      <button
...
import ScannableQrCodePanel from '~/components/settings/externalMessaging/ScannableQrCodePanel.vue';
import type { PersonalSessionProvider } from '~/types/externalMessaging';
