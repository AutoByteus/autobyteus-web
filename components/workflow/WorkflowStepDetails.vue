<template>
      <div v-if="selectedStep" class="flex flex-col h-full w-full bg-white rounded-lg shadow-sm p-4 space-y-6">
        <!-- Conversation Header -->
        ...
        <div class="flex-1 flex flex-col min-h-0 space-y-4">
          ...
          <div class="shrink-0 flex flex-col min-h-0 border-t p-4 bg-gray-50 rounded-lg">
