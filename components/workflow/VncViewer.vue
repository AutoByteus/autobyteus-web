<template>
  <div class="vnc-container h-full flex flex-col">
      ...
      <div class="vnc-screen flex-grow overflow-hidden relative">
        ...
        <!-- View-only mode notification removed as requested -->
      </div>
    </div>
  </template>
  ...
  /* Add WebKit-specific scrollbar styling for macOS */
  @media screen and (-webkit-min-device-pixel-ratio:0) {
    /* Force scrollbars to always be visible in WebKit browsers (macOS) */
    ::-webkit-scrollbar {
