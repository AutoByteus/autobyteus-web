...
import { useNuxt, useNitro, logger, resolvePath, tryResolveModule, resolveAlias, requireModule, isIgnored, addVitePlugin } from '@nuxt/kit';
  ...
  const vitePlugin = {
    ...
    async writeBundle(_options, bundle) {
      for (const chunk of Object.values(bundle)) {
        ...
        const id = resolve$1(outputDir, chunk.fileName);
        ids.add(id);
...
async function resolveCSSOptions(nuxt) {
  ...
  for (const pluginName of sortPlugins(postcssOptions)) {
    ...
    let pluginFn;
    if (pluginPath[0] === ".") {
      pluginPath = resolve$1(nuxt.options.rootDir, pluginPath);
    }
