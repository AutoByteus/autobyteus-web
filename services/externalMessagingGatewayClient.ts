...
export class ExternalMessagingGatewayClient {
...
export function createExternalMessagingGatewayClient(
  options: GatewayClientOptions = {},
): ExternalMessagingGatewayClient {
  return new ExternalMessagingGatewayClient(options);
}

export function createGatewayClientFromRuntimeConfig(): ExternalMessagingGatewayClient {
