 ...
 * @param agentInstanceContext - The context for the agent instance, used for unique ID generation.
...
export function createParserContext(
  ...
  return new ParserContext(segments, strategy, useXml, parseToolCalls, agentInstanceContext);
}
