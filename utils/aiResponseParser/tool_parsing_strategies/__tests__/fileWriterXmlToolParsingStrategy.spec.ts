...
import { FileWriterXmlToolParsingStrategy } from '../fileWriterXmlToolParsingStrategy';
...
describe('FileWriterXmlToolParsingStrategy', () => {
  let segments: AIResponseSegment[];
  let context: ParserContext;
  let strategy: FileWriterXmlToolParsingStrategy;
  ...
  beforeEach(() => {
    ...
    strategy = new FileWriterXmlToolParsingStrategy();
  });

  it('should parse a complete, valid FileWriter block', () => {
    const fullTag = '<tool name="FileWriter"><arguments><arg name="path">a.py</arg><arg name="content">print("hi")</arg></arguments></tool>';
    runStrategy(fullTag);
  ...
  it('should correctly decode XML entities in path but not content', () => {
    const fullTag = '<tool name="FileWriter"><arguments><arg name="path">a&amp;b.txt</arg><arg name="content">1 &lt; 2 &amp;&amp; "hello"</arg></arguments></tool>';
    runStrategy(fullTag);
...
<body>
    ...
    <p>This is a paragraph with a <a href="#">link</a>.</p>
        ...
        const fullTag = `<tool name="FileWriter"><arguments><arg name="path">index.html</arg><arg name="content">${htmlContent}</arg></arguments></tool>`;
        runStrategy(fullTag);
...
`;
        const fullTag = `<tool name="FileWriter"><arguments><arg name="path">component.jsx</arg><arg name="content">${jsxContent}</arg></arguments></tool>`;
        runStrategy(fullTag);
  ...
  "private": true
        ...
        const fullTag = `<tool name="FileWriter"><arguments><arg name="path">package.json</arg><arg name="content">${jsonContent}</arg></arguments></tool>`;
        runStrategy(fullTag);
